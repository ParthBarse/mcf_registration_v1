...
import cclogo from "../../images/chhota commando.jpg";
...
const FirstDetails = () => {
  ...
  // Now, company variable can be used to set the value of company input field
              ...
              <div className="overflow-x-auto">
                <form className="  rounded px-8 pt-6 pb-8 mb-4">
                  ...
                  <p style={{ fontSize: "1.3em" }}>
                    <strong>{`Final Price : ${campFee}`}</strong>
                  </p>
                  <hr className="my-4 h-1 bg-gray-200" />
                  <div className="p-4">
                    <div className="overflow-x-auto text-xs">
                      ...
                      <ul className="list-disc pl-6 mb-4">
                        <li>
                          ...
                          Advance Booking Amount not refundable.
                        </li>
                        <li>
                          If any cancellation occurs due to unavoidable
                          circumstances 30% Fees will be deducted and balance
                          will be returned only after 45 days of the closing of
                          the camp event.
                        </li>
                        <li>
                          For early booking, if there is any change in plans,
                          Parents have to inform us 30 days prior to the opening
                          date of camp and the refund will be initiated from
                          MCF.
                        </li>
                        <li>
                          40 Days Prior To Departure Cancellation 30%of The Trip
                          Cost Will Be Deducted As Cancellation Charges
                        </li>
                        <li>
                          30 Days Prior To Departure Cancellation 60% Of The
                          Trip Cost Will Be Deducted As Cancellation Charges
                        </li>
                        <li>
                          15 Days Prior To Departure Cancellation 80%Of The Trip
                          Cost Will Be Deducted As Cancellation Charges
                        </li>
                        <li>
                          5 Days Prior To Departure Cancellation 100% Of The
                          Trip Cost Will Be Deducted As Cancellation Charges
                        </li>
                      </ul>
